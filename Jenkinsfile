        ...
        parallel(
            ...
            'Nexus': {
                stage('Nexus Maven') {
                    ...
                    withEnv(["MVN_HOME=$toolLocation"]) {
                        sh '"$MVN_HOME/bin/mvn" deploy:deploy-profile -DgroupId=org.cicdlabs -DartifactId=test -Dversion=0.0.0 -Dfile=test.jar -Dpackaging=jar -DgeneratePom=true -DrepositoryId=cicdlab -DrepositoryUrl=http://artifactsrepo:8081/nexus/repository/maven-public/'
                    }
